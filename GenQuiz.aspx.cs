...
namespace quiz
{
    ...
    public class WebForm2 : System.Web.UI.Page
    {
        ...
        private void Page_Load(object sender, System.EventArgs e)
        {
            ...
            string sIntermediates = GetOnOffFormVal("INTERMEDIATES");
            string sJuniors = GetOnOffFormVal("JUNIORS");
            string sSeniors = GetOnOffFormVal("SENIORS");
            string sFed = GetOnOffFormVal("FED");
            string sSoftball = GetOnOffFormVal("SOFTBALL");
            string sBaseball = GetOnOffFormVal("BASEBALL");
            ...
            string sRegular = GetOnOffFormVal("REGULAR");
            string sTournament = GetOnOffFormVal("TOURNAMENT");

            int nCount = GetFormIntVal("COUNT", 5);

            oSupp.GenerateQuiz(nCount, sMinors, sMajors, sIntermediates, sJuniors, sSeniors, sBaseball, sSoftball, sLocal, sFed, sDiff1, sDiff2, sDiff3, sDiff4, sDebugList, sRegular, sTournament);
